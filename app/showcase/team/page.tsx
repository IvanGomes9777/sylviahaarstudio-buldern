...
import {
  ...
  TeamEditorial,
  TeamPolaroid,
} from "@/components/sections/team/TeamVariants";

const VARIANTS = [
  { id: "1", name: "Karten + Hover-Zoom", T: TeamCards },
  { id: "2", name: "Kreis-Porträts", T: TeamCircles },
  { id: "3", name: "Hover-Reveal", T: TeamHoverReveal },
  { id: "4", name: "Editorial-Reihen", T: TeamEditorial },
  { id: "5", name: "Polaroid (dunkel)", T: TeamPolaroid },
];

export default function TeamShowcase() {
  const [active, setActive] = useState("1");
  const current = VARIANTS.find((v) => v.id === active)!;
  const ActiveT = current.T;
